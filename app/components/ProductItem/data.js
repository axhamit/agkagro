...
const product_data = [
   {
      id:26,
      title: "Makhana Phool",
      description: "Fox nuts, or makhana phool, are nutritious, popped seeds from the prickly waterlily (Euryale ferox), a water plant...",
      image: makhana_veg,
      date: Date.now(),
      category: 'Edible seeds/ Nuts/ Dried fruits',
      heading1:"Makhana Phool or Fox Nut: An Overview",
